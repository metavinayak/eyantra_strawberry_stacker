...
class stateMoniter:
    ...
    def __init__(self):
        ...
        state_sub = rospy.Subscriber('/mavros/state', State, callback=self.stateCb)
...
def main():
    ...
    vel_sub = rospy.Subscriber('/mavros/local_position/velocity', Twist)
    pos_sub = rospy.Subscriber('/mavros/local_position/pose', PoseStamped)#, callback=local_pos_pub

    state_sub = rospy.Subscriber('/mavros/state', State, callback=stateMt.stateCb)
    ...
    rpos.pose.position.z = 10
    rpos.pose.position.y = 0
    rpos.pose.position.x = 0
