...
# Calling the rosservices
    ...
    def wpPush(self,index,wps):
        ...
        try:
            ...
            print ("Service pushing wp failed: %s"%e)
    ...
    def wpPull(self):
        ...
        try:
            wpPushService = rospy.ServiceProxy('mavros/mission/pull', WaypointPull)
            wpPushService()
            print("Pulled!!")
        except rospy.ServiceException as e:
            print ("Service pulling wp failed: %s"%e)
